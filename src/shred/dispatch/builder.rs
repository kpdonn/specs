...
use shred::dispatch::dispatcher::{SystemId, ThreadLocal};
use shred::dispatch::stage::StagesBuilder;
use shred::dispatch::Dispatcher;
use shred::system::{RunNow, System};
...
impl<'a, 'b> DispatcherBuilder<'a, 'b> {
    ...
    pub fn build(self) -> Dispatcher<'a, 'b> {
        use shred::dispatch::dispatcher::new_dispatcher;
